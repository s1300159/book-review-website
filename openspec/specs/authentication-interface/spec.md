# authentication-interface Specification

## Purpose
Define the standard Django authentication URLs, named login settings, and
secure login presentation used by protected Review workflows without adding
user registration.
## Requirements
